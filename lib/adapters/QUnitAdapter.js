...
export default class QUnitAdapter extends EventEmitter {
  ...
  /**
   * @param suiteNameParam is used only when the test does not contain the
   * parent module name, if it is available in the test, then it is undefined.
   *
   * The parent module name is not available when converting the suites on
   * the "runtStart" event.
   */
